...
int main() {
   ...
   //nivel mestre, variaveis adicionadas
   ...
   float superPoder1, superPoder2;
    ...
    pibpercapita = (Populacao != 0) ? pibTotal / Populacao : 0.0f;
    pibpercapita2 = (Populacao2 != 0) ? pibTotal2 / Populacao2 : 0.0f;
